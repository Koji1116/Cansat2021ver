...
path_photo ='/home/pi/Desktop/Cansat2021ver/test/photostorage640/'
srcdir = '/home/pi/Desktop/Cansat2021ver/test/photostorage'
dstdir = '/home/pi/Desktop/Cansat2021ver/test/result2'


def panorama_shooting(srcdir, dstdir, width=640, height=480):
    """
    パノラマ撮影用の関数
    """
    ...
    if input('パノラマ合成しますか？y/n') == 'y':
        t_start = time.time()
        panoramatest.panorama(srcdir=srcdir, dstdir=dstdir, dstprefix='panoramashooting640')
