...
def GoalDetection(imgpath, H_min, H_max, S_thd, G_thd):
    try:
        ...
        img_contour = cv2.drawContours(img, contours[max_area_contour], 6, (0, 255, 0), 5)
...
imgpath = 'photostorage/ImageGuidance6.jpg'
H_min = 200
H_max = 10
S_thd = 120
G_thd = 0
...
GoalDetection(imgpath, H_min, H_max, S_thd, G_thd)